...
public class Ex19AnimalMain {
	...
	public static void main(String[] args) {
		//	Ex19Animal animal = new Ex19Animal();	// 추상클래스는 new불가능
		...
		animalFind.find(cow); // 주소를 치환한다는 점에서 animal = cow; 와 같은 뜻이다.
		
		System.out.println();
		animalFind.find(lion);	// 주소를 치환한다는 점에서 animal = lion; 와 같은 뜻이다.
